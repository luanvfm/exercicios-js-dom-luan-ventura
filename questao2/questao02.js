function mudarForma() {
    ...
    if (btnText == "Mudar Forma") {
        estiloDiv.style = "width: 200px; height: 200px; background-color: blue;border-radius: 0%; transition: ease-in-out 400ms;"
        btn.innerText = "Retornar a Forma Original."

    } else if (btnText == "Retornar a Forma Original.") {
        estiloDiv.style = "width: 200px; height: 200px; background-color: blue; border-radius: 50%; transition: ease-in-out 400ms;"
